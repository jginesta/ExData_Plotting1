...
par(mfrow=c(2,2))
plot(HHPowerConsumption2007$Time,HHPowerConsumption2007$Global_active_power,type="l", ylab="Global Active Power",xlab=" ")
plot(HHPowerConsumption2007$Time,HHPowerConsumption2007$Voltage,type="l", ylab="Voltage",xlab="datetime")
...
plot(HHPowerConsumption2007$Time,HHPowerConsumption2007$Global_reactive_power,type="l", ylab="Global_reactive_power",xlab="datetime")
